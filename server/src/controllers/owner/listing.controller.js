...
/**
 * @description Controller to fetch a specific car listing by ID for owner view
 * @param {Object} req - Express request object
 * @param {Object} res - Express response object
 * @returns {Promise<void>} - Returns the requested listing
 */
const viewListingOwnerController = async (req, res) => {
  try {
...
export { viewListingOwnerController };
